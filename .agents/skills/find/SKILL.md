---
name: find
description: Locate and cite the exact filesystem locations that answer the query.
---
...
Turn budget: at most 3 turns total (including the final answer turn). This is a cap, not a target.
...
Task: locate and cite the exact filesystem locations that answer the query.
